...
import { CHENNAI_CENTER, PORTS, AIRPORTS, SIDCO_PARKS, SIPCOT_PARKS, NH48_CHENNAI_KRISHNAGIRI_COORDS, NH32_CHENNAI_TRICHY_COORDS, NH16_CHENNAI_TADA_COORDS, NE7_CHENNAI_BENGALURU_EXPRESSWAY_COORDS, CHENNAI_THATCHOOR_EXPRESSWAY_COORDS, CHENNAI_OUTER_RING_ROAD_COORDS, CHENNAI_PERIPHERAL_RING_ROAD_COORDS, STRR_SATELLITE_TOWN_RING_ROAD_COORDS, CHENGALPET_CIRCLE_COORDS, THIRUVALLUR_CIRCLE_COORDS } from '@/lib/constants';
  ...
  return (
    <>
      ...
      >
        ...
        <Polygon coords={THIRUVALLUR_CIRCLE_COORDS} color="#FF4500" />
